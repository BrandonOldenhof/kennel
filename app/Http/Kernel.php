...
use App\Http\Middleware\AddReferrerPolicyHeader;
use App\Http\Middleware\AddXContentTypeOptionsHeader;
use App\Http\Middleware\AddXFrameOptionsHeader;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        AddReferrerPolicyHeader::class,
        AddXContentTypeOptionsHeader::class,
        AddXFrameOptionsHeader::class,
